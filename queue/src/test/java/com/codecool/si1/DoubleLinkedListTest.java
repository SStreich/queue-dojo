...
class DoubleLinkedListTest {
    ...
    private DoubleLinkedList<String> linkedList = new DoubleLinkedList<>();
    ...
    void testIfLinkedListCreatesHeadProperly() {
        ...
        linkedList.add(data);
        DoubleNode head = linkedList.getHead();
    ...
    void testIfRemovingNodeFromEmptyListThrowsNoSuchElementException() {
        DoubleNode<String> node = new DoubleNode<>("data of independent node");
    ...
    void testIfRemovingNodeChangesLengthProperly() {
        DoubleNode<String> node = new DoubleNode<>("node to remoove");
    ...
    void testGetTailIfOnlyHeadInList() {
        ...
        DoubleLinkedList<String> tail = linkedList.getTail();
